          ...
          <div className="w-full max-w-full space-y-4 break-words text-x">
            ...
            <div className="flex items-center max-w-full gap-2 break-all">
              ...
              <span className="w-full max-w-full break-all">
                <strong>Website:</strong> <a href={formData.website} target="_blank" rel="noreferrer" className="underline">{formData.website}</a>
              </span>
            </div>
            <div className="flex items-center max-w-full gap-2 break-all">
        ...
        <div className="flex flex-col justify-between h-full p-6 text-black bg-gray-100 border border-black shadow-md rounded-xl">
            ...
            {fields.map(({ label, name, type, placeholder }) => (
              <div key={name}>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 mt-1 placeholder-gray-400 bg-transparent border border-gray-600 rounded-md focus:ring-white focus:border-white"
                />
              </div>
            ))}
          </div>
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 mt-1 bg-transparent border border-gray-600 rounded-md focus:ring-white focus:border-white"
              rows="4"
            />
          </div>
